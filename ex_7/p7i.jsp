...
try {
    ...
    PreparedStatement ps = conn.prepareStatement("UPDATE dancer set Age=? where Name=?");
    ...
    out1.println("<script>function R() {location.replace('http://localhost:8080/ex_7/p7.jsp')}</script>");
